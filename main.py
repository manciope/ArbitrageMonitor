...
def update_tab1(ui):
    def insert_table1(i, min_time, max_time, price1, price2, latest_diff, pre_diff, diff_10, diff_20, diff_30, min_diff,
                      percentile5, avg_diff, percentile95, max_diff):
        ...
        ui.tableWidget.setItem(i, 11, QtWidgets.QTableWidgetItem(str(avg_diff)))
    ...
    def f0():
        i = 0  # 豆油/豆粕
        min_time, max_time, price1, price2, latest_diff, pre_diff, diff_10, diff_20, diff_30, min_diff, percentile5, avg_diff, percentile95, max_diff = cf.difference(
            'y0', 'm0', method='divide')
